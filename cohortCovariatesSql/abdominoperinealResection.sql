...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4144721,2147483238,2147483237,2147483236)
...
WHERE PR.specialty_concept_id in (2147483509)
